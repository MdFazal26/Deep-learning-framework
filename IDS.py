...
main = tkinter.Tk()
main.title("Deep Learning Based Intrusion Detection Framework in Industrial Internet of Things")
...
def runDNN():
    ...
    Y = Y.astype('uint8')
    Y1 = to_categorical(Y)
    model = Sequential() #creating RNN model object
...
font = ('times', 16, 'bold')
title = Label(main, text='Deep Learning Based Intrusion Detection Framework in Industrial Internet of Things')
title.config(bg='LightSteelBlue1', fg='LightSteelBlue4')  
